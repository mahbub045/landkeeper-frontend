import {
  NotificationSetting,
  UsageStat,
} from '@/types/landlord/Tools/Settings/SettingsTypes';

export const defaultNotifications: NotificationSetting[] = [
  {
    id: 'email',
    title: 'Email Alerts',
    description: 'Receive compliance and renewal reminders',
    enabled: true,
  },
  {
    id: 'sms',
  ...
  },
  {
    ...
    description: 'Portfolio performance email every Monday',
    enabled: true,
  },
  {
    id: 'docs',
    title: 'Document Upload Alerts',
    description: 'Notify when team members upload documents',
    enabled: true,
  },
];
