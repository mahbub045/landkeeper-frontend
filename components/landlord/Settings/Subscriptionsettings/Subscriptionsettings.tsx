  ...
  return (
    <Card className='pt-0'>
      <CardContent className='space-y-6 p-6'>
        ...
        {/* Plan banner */}
       <div className='flex items-center justify-between rounded-2xl border border-border bg-white px-6 py-5 dark:border-0 dark:bg-gray-900'>
  <div>
    <p className='text-lg font-bold text-foreground dark:text-white'>Premium Plan</p>
    <p className='mt-0.5 text-sm text-muted-foreground dark:text-gray-300'>
