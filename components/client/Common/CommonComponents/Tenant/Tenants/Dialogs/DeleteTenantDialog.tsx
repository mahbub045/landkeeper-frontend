...
import { useDeleteTenantMutation } from '@/store/api/endpoints/client/Common/Tenant/TenantsApi';
import { DeleteTenantDialogProps } from '@/types/client/Common/Tenant/TenantsTypes';
